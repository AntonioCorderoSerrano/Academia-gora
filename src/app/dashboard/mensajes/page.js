...
export default function MensajesPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-4xl mb-2">Mensajes</h1>
      <p className="text-ink-600 mb-8">Conversaciones por clase.</p>
        ...
        <div className="card divide-y divide-ink-100">
          {clases.map((c) => (
            <Link
              ...
              className="p-4 flex items-center gap-4 hover:bg-ink-50/60 transition"
            >
